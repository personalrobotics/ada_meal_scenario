...
class AssistancePolicyAction(BypassableAction):
    ...
    def _run(self, manip, objects, desired_ee_poses, ui_device, fix_magnitude_user_command=False, blend_only=False):
        ...
        ada_handler.execute_policy(simulate_user=False, blend_only=blend_only, fix_magnitude_user_command=fix_magnitude_user_command)
